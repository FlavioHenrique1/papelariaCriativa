                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-6">
                            <input type="radio" name="forma_pagamento" value="dinheiro"
                                id="dinheiro" class="btn-check" checked>

                            <label for="dinheiro"
                                class="btn btn-outline-secondary border w-100 d-flex flex-column align-items-center py-3 metodo-btn">
                                <span class="material-symbols-outlined text-blue-600">payments</span>
                                <span class="text-xxs fw-bold mt-1">Dinheiro</span>
                            </label>
                        </div>

                        <div class="col-6">
                            <input type="radio" name="forma_pagamento" value="pix"
                                id="pix" class="btn-check">

                            <label for="pix"
                                class="btn btn-outline-secondary border w-100 d-flex flex-column align-items-center py-3 metodo-btn">
                                <span class="material-symbols-outlined text-blue-600">qr_code_2</span>
                                <span class="text-xxs fw-bold mt-1">PIX</span>
                            </label>
                        </div>

                        <div class="col-6">
                            <input type="radio" name="forma_pagamento" value="orcamento"
                                id="orcamento" class="btn-check">

                            <label for="orcamento"
                                class="btn btn-outline-secondary border w-100 d-flex flex-column align-items-center py-3 metodo-btn">
                                <span class="material-symbols-outlined text-blue-600">description</span>
                                <span class="text-xxs fw-bold mt-1">Orçamento</span>
                            </label>
                        </div>
